...
**_РЕЗУЛЬТАТ:_** Реєстрація користувача у системі
...
**_РЕЗУЛЬТАТ:_** Авторизація користувача у системі
...
**_ПЕРЕДУМОВИ:_** Наявність проекту
...
**_ПЕРЕДУМОВИ:_** Наявність створених завдань
